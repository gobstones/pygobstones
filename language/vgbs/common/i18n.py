...
# lint errors
  ...
  'There should be a "program" block.':
    'El programa debería tener un bloque "program".',
  # cannot define
 ...
 '%i values are expected':
  ...
  'Literals in a switch should be disjoint':
    'No puede haber literales repetidos en un switch',
  #
  'Index of a foreach cannot be a variable: "%s"':
    'El índice de un foreach no puede ser una variable: "%s"',
  'Index of a foreach cannot be a parameter: "%s"':
    'El índice de un foreach no puede ser un parámetro: "%s"',
  #
  'Cannot modify "%s": parameter is immutable':
    'No se puede modificar "%s": es un parámetro',
  'Cannot modify "%s": index of a foreach is immutable':
    'No se puede modificar "%s": es el índice de un foreach',

  'Nested foreach\'s cannot have the same index: "%s"':
    'foreach anidados no pueden tener el mismo índice: "%s"',
  #
